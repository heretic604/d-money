...
public class SaveWithdrawalOperationInsufficientFundsArguments implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        return Stream.of(Arguments.of(WITHDRAWAL_OPERATION_REQUEST, WALLET_RESPONSE));
    }
}